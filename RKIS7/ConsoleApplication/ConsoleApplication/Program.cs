...
namespace ConsoleApplication
{
    ...
    internal class Program
    {
        ...
        static void AddTask()  // функция для добавления задачи
        {
        ...
        static void DeleteTask() // функция удаления задач
        {
        ...
        static void EditTask()  //функция для редактирования задачи
        {
        ...
        static void ViewTheTasksForDate(DateTime date) //функция просмотра задач на сегодня
        {
        ...
        static void ViewTheTasksForWeek()  //функция просмотра задач на неделю
        {
        ...
        static void ViewTheListOfAllTasks()  //функция всех задач
        {
